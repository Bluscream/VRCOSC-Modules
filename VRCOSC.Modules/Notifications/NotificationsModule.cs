...
public class NotificationsModule : Module
{
    ...
    protected override void OnPreLoad()
    {
        ...
        CreateTextBox(NotificationsSetting.DefaultIcon, "Default Icon Path", "Path to default notification icon image (leave empty for built-in)", string.Empty);
        ...
        // Groups
        CreateGroup("Defaults", "Default notification settings", NotificationsSetting.DefaultTimeout, NotificationsSetting.DefaultOpacity, NotificationsSetting.DefaultIcon);
        CreateGroup("Targets", "Enable/disable notification targets", NotificationsSetting.EnableDesktop, NotificationsSetting.EnableXSOverlay, NotificationsSetting.EnableOVRToolkit);
    ...
    public string GetDefaultIcon() => GetSettingValue<string>(NotificationsSetting.DefaultIcon);
}
